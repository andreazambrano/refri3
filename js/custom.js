...
function thmOwlCarousel() {
    ...
    if ($('.feature-carousel').length) {
        ...
        $('.service-carousel-nav .left-nav').on('click', function() {
           $('.service-carousel').trigger('next.owl.carousel'); 
        });
        $('.service-carousel-nav .right-nav').on('click', function() {
    ...
    if ($('.gallery-carousel').length) {
        ...
        $('.gallery-nav .left-nav').on('click', function() {
           $('.gallery-carousel').trigger('next.owl.carousel'); 
        });
        $('.gallery-nav .right-nav').on('click', function() {
...
function mobileNavToggle () {
    if ($('.navbar .navbar-nav .sub-menu').length) {
        $('.navbar .navbar-nav .sub-menu').parent('li').children('a').append(function () {
            return '<button class="sub-nav-toggler"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>';
        });
        $('.navbar .navbar-nav .sub-nav-toggler').on('click', function () {
            var Self = $(this);
